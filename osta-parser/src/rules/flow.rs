...
mod tests {
    use super::*;
    use crate::tests::{assert_ast, identifier, int};
    ...
    fn simple_if_else_statement() {
        assert_ast!(
            ...
            [
                // cond
                Node {
                    kind: NodeKind::IntegerLiteral(DataRef(0)),
                    ..
                },
                Node {
                    kind: NodeKind::Term(NodeRef(0)),
                    ..
                },
                // if_then
                Node {
                    kind: NodeKind::IntegerLiteral(DataRef(1)),
                    ..
                },
                Node {
                    kind: NodeKind::Term(NodeRef(2)),
                    ..
                },
                // else
                Node {
                    kind: NodeKind::IntegerLiteral(DataRef(2)),
                    ..
                },
                Node {
                    kind: NodeKind::Term(NodeRef(4)),
                    ..
                },
                Node {
                    kind: NodeKind::IfStmt {
                        cond_ref: NodeRef(1),
                        then_block_ref: NodeRef(3),
                        else_block_ref: NodeRef(5)
                    },
                    ..
                }
            ],
    ...
    fn if_statement_with_block_expression() {
        assert_ast!(
            parse_if_stmt,
            "if should_enter_if() { func1(); func2(); } ",
            [
                // cond
                Node {
                    kind: NodeKind::Identifier(DataRef(0)),
                    ..
                },
                Node {
                    kind: NodeKind::FuncCallExpr {
                        name_ref: NodeRef(0),
                        first_param_ref: NodeRef::NULL
                    },
                    ..
                },
                // if_then
                // func1()
                Node {
                    kind: NodeKind::Identifier(DataRef(1)),
                    ..
                },
                Node {
                    kind: NodeKind::FuncCallExpr {
                ...
                // func2()
                Node {
                    kind: NodeKind::Identifier(DataRef(2)),
                    ..
                },
                Node {
                    kind: NodeKind::FuncCallExpr {
                ...
                Node {
                    kind: NodeKind::IfStmt {
                        cond_ref: NodeRef(1),
                        then_block_ref: NodeRef(10),
                        else_block_ref: NodeRef::NULL
                    },
                    ..
                }
            ],
    ...
    fn do_nobody_while_cond() {
        assert_ast!(
            ...
            [
                Node {
                    kind: NodeKind::Block {
                        first_stmt_ref: NodeRef::NULL
                    },
                    ..
                },
                Node {
                    kind: NodeKind::DoWhile {
                        do_expr_ref: NodeRef::NULL,
                        cond_ref: NodeRef(0)
                    },
                    ..
                }
